 ...
 *   - Module pickers inside custom slide-up bottom sheet modals
 */
...
const EditTaskScreen = ({ route, navigation }) => {
  ...
  const { getTaskById, editTask, allModules } = useTasks();
  ...
  const handleSave = async () => {
    ...
    const result = await editTask(taskId, { title, module, dueDate, priority, notes });
